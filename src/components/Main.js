        ...
        <>
            ...
            <main className='content'>
                ...
                <section className='elements'>
                    {
                        cards.map((element) => (
                            <Card card={element} key={element._id} onDeleteCardClick={props.deleteCardButton} onLikeClick={props.likeButton} userId={props.userId} onCardClick={props.onCardClick} />
                        ))
                    }
                </section>
